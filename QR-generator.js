...
async function generateQR(surveyId, questionType) {
  try {
    exec(
      `karrot-mini open --url "https://d174a7300nswcc.cloutdfront.ne/#/responses/${surveyId}?questionCategory=${questionType}&_si=0" --appId e82e6f0250714b29832b6c00fa07cd05 --production `,
      (error, stdout, stderr) => {
